...
class Dashboard extends React.Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			templates: this.props.auth.user.templates
				? this.props.auth.user.templates
				: [],
			searchResults: [],
		};
	}
	...
	/*
	 * Search for all templates by this user
	 */
	searchTemplatesByUser = async () => {
		await getTemplateByUser(this.props.auth.user["_id"]).then(
			(templates) => {
...
export default connect(mapStateToProps, { getTemplateByUser })(Dashboard);
